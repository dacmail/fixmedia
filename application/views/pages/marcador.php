<div id="container" class="columns static clearfix">
	<div id="content">
		...
		<p class="relative"><a href="javascript:(function()%7B%20%20_my_script%3Ddocument.createElement(%27SCRIPT%27)%3B%20%20_my_script.type%3D%27text/javascript%27%3B%20%20_my_script.src%3D%27http://fixmedia.org/js/bookmarklet.js%27%3B%20%20document.getElementsByTagName(%27head%27)%5B0%5D.appendChild(_my_script)%3B%7D)()%3B" class="bookmarklet">Hacer FIX</a> <span id="bookmarklet-arrow"></span></p>
		...
		<p class="small"><strong>Importante</strong>: El marcador de Fixmedia NO guarda ningún tipo de información de tu navegación ni ningún dato personal. Los FIX y reportes que hagas desde tu marcador aparecerán en tu perfil igual que si los hubieras hecho desde Fixmedia.org.</p>

		<p class="small"><strong>¿Dudas? ¿Problemas para usar el marcador?</strong> Escríbenos cuando quieras a comunidad(arroba)fixmedia(punto)org</p>
